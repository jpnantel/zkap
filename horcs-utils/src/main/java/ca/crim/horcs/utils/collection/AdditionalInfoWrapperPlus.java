 ...
 * 
 */
public class AdditionalInfoWrapperPlus implements Comparable<AdditionalInfoWrapperPlus> {

    private static final I18n i18n = I18n.getInstance(AdditionalInfoWrapperPlus.class);

    private Comparable<?> mainInfo;

    private Comparable<?> additionalInfo;

    public AdditionalInfoWrapperPlus(Comparable<?> mainInfo, Comparable<?> additionalInfo) {
        if (mainInfo == null) {
    ...
    @Override
    public int compareTo(AdditionalInfoWrapperPlus o) {
